...
movies = read.csv("movies.csv", header = TRUE) %>% 
  mutate(title = as.character(title),
         ...
         budget_size_2013 = cut(budget_2013.,c(0,25000000,50000000,75000000,100000000,125000000,150000000,175000000,200000000,225000000,250000000,275000000),labels=F)
```
